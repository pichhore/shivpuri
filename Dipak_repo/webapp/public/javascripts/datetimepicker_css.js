...
var EndYear = +200; //End Year offset. i.e. Current Year + 5
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
     ...
     // add javascript function to the span cal
       ...
       with (span.style) {position = "absolute"; left = '521px'; top = '788px'; width = CalWidth+'px'; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100;}
	  ...
	  if(bNewCal==true){
	     winCal.style.left = '521px';
	     winCal.style.top = '788px';
	   }
	}
