  ...
  var _pub = {
    ...
    hide: function() {
      ...
      // restore elements that were hidden
          calender = document.getElementById("calBorder")
    if(calender!= null){
    visibility='hidden'
...
//     calender.style.display="none";
    ...
    reposition: function() {
      ...
      if (active.dimensions) {
        ...
        //  els.wrapper.style.height = els.content.offsetHeight + offset.wrapper[1] + 'px';	//comment by mayank
	  els.wrapper.style.height = '600px';
        }
        else {
          els.wrapper.style.height = els.content.offsetHeight + offset.wrapper[1] + 'px';alert(els.content.offsetHeight + offset.wrapper[1] + 'px')
        }
  ...
  var create = function(elem) {
    ...
    else els.overlay.style.backgroundImage = "url('" + _pub.base_url + "/images/bg11.png')";
    ...
    els.loading.innerHTML = '<img src="/images/active_scaffold/default/indicator.gif" alt="Loading..."/>';
    els.loading.style.display = 'none';
    ...
    child2.innerHTML = '<img src="/images/active_scaffold/default/close.gif" alt="Close"/>';
