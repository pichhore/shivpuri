...
YAHOO.com.thecodecentral.Lightbox_Click = function(conf){
...
YAHOO.com.thecodecentral.Lightbox_Click.prototype._init = function(){
	$D.addClass(document.body, 'yui-skin-sam');
};

YAHOO.com.thecodecentral.Lightbox_Click.prototype._loadData = function(){
	...
	for(var i in r){
		var onImgClick = function(e, o){
			...
			// Had to set this timeout for, you guessed it, IE7
			setTimeout(function() {
...
YAHOO.com.thecodecentral.Lightbox_Click.prototype._autoFit = function(image){
	var iw = image.width ;
	var ih = image.height;
...
YAHOO.com.thecodecentral.Lightbox_Click.prototype._initLoader = function(){
...
YAHOO.com.thecodecentral.Lightbox_Click.prototype._initLightbox = function(){
...
YAHOO.com.thecodecentral.Lightbox_Click.prototype._setResizeButton = function(type){
