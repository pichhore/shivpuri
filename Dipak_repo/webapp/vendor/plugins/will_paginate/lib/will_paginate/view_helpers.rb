...
module WillPaginate
  ...
  class LinkRenderer
    ...
    def to_html
      ...
      links.unshift page_link_or_span(1, 'disabled prev_page', '<b>|</b><b style="font-size:11px;"><</b>')
      links.push    page_link_or_span(@collection.next_page,     'disabled next_page', @options[:next_label])
     links.push    page_link_or_span(total_pages , 'disabled next_page', '<b style="font-size:11px;">></b><b>|</b>')
