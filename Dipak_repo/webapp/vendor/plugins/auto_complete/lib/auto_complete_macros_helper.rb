module AutoCompleteMacrosHelper      
  ...
  def auto_complete_result(entries, field1, field2, phrase = nil)
    return unless entries
    items = entries.map { |entry| content_tag("li", phrase ? highlight(entry[field1]+" "+entry[field2], phrase) : h(entry[field1]+" "+entry[field2])) }
